{
  ...
  "next_offset": null,
  "notes": [
    "This price check spent one allowance unit.",
    "An offer is a price, not a booking. Prices are valid until each offer’s valid_until."
  ]
}
